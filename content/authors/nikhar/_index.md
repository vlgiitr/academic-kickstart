...
bio: Interested in Sports (Cricket, Badminton , Chess), Hip Hop , Stand up
...
- icon: envelope
  icon_pack: fas
  link: 'mailto:n_waghela@ma.iitr.ac.in'  # For a direct email link, use "mailto:test@example.org".
# - icon: google-scholar
#   icon_pack: ai
#   link: https://scholar.google.com/citations?user=9TPamcgAAAAJ&hl=en
- icon: github
  icon_pack: fab
  link: https://github.com/NikharW
- icon: linkedin
  icon_pack: fab
