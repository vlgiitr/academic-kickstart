...
bio: Passionate about machine learning,mathematics and finance. I also enjoy playing badminton and reading novels.
...
- icon: envelope
  icon_pack: fas
  link: 'mailto:m_gupta@ma.iitr.ac.in'  # For a direct email link, use "mailto:test@example.org".
# - icon: google-scholar
#   icon_pack: ai
#   link: https://scholar.google.com/citations?user=9TPamcgAAAAJ&hl=en
- icon: github
  icon_pack: fab
  link: https://github.com/MansiGupta1603
- icon: linkedin
  icon_pack: fab
  link: https://www.linkedin.com/in/mansi-gupta-867b28227
